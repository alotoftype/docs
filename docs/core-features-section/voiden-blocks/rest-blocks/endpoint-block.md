...
![endpoint](/img/voiden-blocks/endpoint-pre.png)
...
3. Check the **Response Panel** — you’ll see the status, delay, and the endpoint you sent a request to.
