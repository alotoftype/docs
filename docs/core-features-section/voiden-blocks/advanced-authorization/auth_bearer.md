...
**Voiden** support straightforward authentication to keep things secure without the headache. You can use the classic [Basic Authorization](/docs/core-features-section/voiden-blocks/advanced-authorization/auth_basic.md) method, where your username and password team up like old friends to get you in.
