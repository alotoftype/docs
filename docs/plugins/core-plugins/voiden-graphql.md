...
GraphQL is built around three main operation types. Voiden supports all of them.
...
See the [GraphsQL variable documenatation](https://graphql.org/learn/queries/#variables)
